package jp.pycon.pyconjp2017app.Feature.Keynote;
...
import jp.pycon.pyconjp2017app.Model.GHPages.KeynoteEntity;
...
public class KeynoteFragment extends Fragment {
    ...
    private void showKeynotes(List<KeynoteEntity> list) {
        ...
        GAUtil.sendCommonScreen(context, getString(R.string.keynote));
    }
